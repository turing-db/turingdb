...
cp $SCRIPT_DIR/people.csv $SCRIPT_DIR/.turing/data/
cp $SCRIPT_DIR/edges.csv $SCRIPT_DIR/.turing/data/

# Now start daemon to run LOAD CSV + CREATE tests via Python SDK
