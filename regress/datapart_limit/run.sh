...
# Cap the number of data parts so COMMIT / CHANGE SUBMIT get rejected once the graph
# has accumulated too many parts. The server reads this at startup.
export TURING_MAX_DATAPARTS=4
