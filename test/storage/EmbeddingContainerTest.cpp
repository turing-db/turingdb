...
TEST(EmbeddingContainerTest, AllocAndRetrieve) {
    ...
    ASSERT_EQ(container.getEmbeddingCount(), 3);
...
TEST(EmbeddingContainerTest, OverflowToBucket) {
    ...
    ASSERT_EQ(container.getEmbeddingCount(), count);
...
TEST(EmbeddingContainerTest, Clear) {
    ...
    ASSERT_EQ(container.getEmbeddingCount(), 2);

    container.clear();

    ASSERT_EQ(container.getEmbeddingCount(), 0);
