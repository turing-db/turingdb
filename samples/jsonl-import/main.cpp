...
int main(int argc, const char** argv) {
    std::stringstream input {R"(
        ...
        {"type":"relationship","id":"5","label":"INTERESTED_IN","properties":{"name":"Adam -> Bio"},"start":{"id":"1","labels":["Bioinformatics","Founder","Person"],"properties":{"isF rench":true,"dob":"18/08","hasPhD":true,"name":"Adam","age":32}},"end":{"id":"7","labels":["Interest"],"properties":{"name":"Bio"}}}
        {"type":"relationship","id":"6","label":"INTERESTED_IN","properties":{"name":"Adam -> Cooking"},"start":{"id":"1","labels":["Bioinformatics","Founder","Person"],"properties":{ "isFrench":true,"dob":"18/08","hasPhD":true,"name":"Adam","age":32}},"end":{"id":"8","labels":["Interest"],"properties":{"name":"Cooking"}}}
