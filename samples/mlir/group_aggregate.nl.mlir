// Generated nl-dialect lowering of group_aggregate.mlir (db dialect).
// Reproduce with: mlir -dump-lowered group_aggregate.mlir -graph <graph>
// This is the DBLowering output; edit group_aggregate.mlir, not this file.
//
...
// !storage.nullable<!storage.string> chunk; the sum keeps score's i64 and the avg
// widens to an f64.
module {
  func.func @main() {
    ...
    %4 = nl.group_aggregate(%0) : !nl.iter<!nl.chunk<!storage.nullable<!storage.string>>, !nl.chunk<!storage.nullable<i64>>, !nl.chunk<!storage.nullable<f64>>>
    nl.for %arg0, %arg1, %arg2 in %4 : !nl.iter<!nl.chunk<!storage.nullable<!storage.string>>, !nl.chunk<!storage.nullable<i64>>, !nl.chunk<!storage.nullable<f64>>> {
      nl.output(%arg0, %arg1, %arg2) : !nl.chunk<!storage.nullable<!storage.string>>, !nl.chunk<!storage.nullable<i64>>, !nl.chunk<!storage.nullable<f64>>
    }
    return
  }
}
