...
enum class ErrorType : uint8_t {
    ...
    NOT_EXISTS,
    NOT_DIRECTORY,
    CANNOT_GET_CANONICAL_PATH,
    CANNOT_GET_CURRENT_DIR,
    ALREADY_EXISTS,
    CANNOT_MKDIR,
    CANNOT_REMOVE,
    CANNOT_RENAME,
...
using ErrorTypeDescription = EnumToString<ErrorType>::Create<
    ...
    EnumStringPair<ErrorType::CANNOT_GET_CANONICAL_PATH, "Could not get canonical path">,
    EnumStringPair<ErrorType::CANNOT_GET_CURRENT_DIR, "Could not get current working directory">,
    ...
    EnumStringPair<ErrorType::CANNOT_RENAME, "Could not rename">,
