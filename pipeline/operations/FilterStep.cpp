...
void FilterStep::compute() {
    for (const Expression& expr : _expressions) {
        switch (getOpCase(expr._op, expr._lhs->getKind(), expr._rhs->getKind())) {
            ...
            EQUAL_CASE(ColumnVector<LabelID>, ColumnVector<LabelID>)
            EQUAL_CASE(ColumnVector<LabelID>, ColumnConst<LabelID>)
            EQUAL_CASE(ColumnConst<LabelID>, ColumnVector<LabelID>)
            EQUAL_CASE(ColumnConst<LabelID>, ColumnConst<LabelID>)
