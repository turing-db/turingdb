...
//
// A file that cannot be opened, a line without an ID, a token that is not a number,
// and a line whose value count disagrees with the batch's dimension are all malformed
// input and throw VectorException. Blank lines are skipped.
