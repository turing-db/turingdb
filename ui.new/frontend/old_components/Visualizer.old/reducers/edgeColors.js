...
const useEdgeColors = () => {
    const [state, dispatch] = React.useReducer(useEdgeColorsReducer, edgeColorsInitialState());

    const setEdgeColorMode = React.useCallback((mode, elementIds = [], data = {}) => dispatch({
