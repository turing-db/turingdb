...
export const edgeLabelInitialState = () => "EdgeType";
...
const useEdgeLabel = () => {
    const [state, dispatch] = React.useReducer(useEdgeLabelReducer, edgeLabelInitialState());

    const setEdgeLabel = (edgeLabel) => dispatch({
        type: SET_EDGE_LABEL,
        payload: { edgeLabel },
    });
