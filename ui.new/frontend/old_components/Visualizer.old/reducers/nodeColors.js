...
const useNodeColors = () => {
    const [state, dispatch] = React.useReducer(useNodeColorsReducer, nodeColorsInitialState());

    const setNodeColorMode = React.useCallback((mode, elementIds = [], data = {}) => dispatch({
