...
export const setSelectedNodes = (nodes) => ({
  type: actions.SET_SELECTED_NODES,
  payload: { nodes },
});
...
export const unselectNodes = (nodes) => ({
  type: actions.UNSELECT_NODES,
  payload: { nodes },
});
...
export const setNodeLabel = (nodeLabel) => ({
  type: actions.SET_NODE_LABEL,
  payload: { nodeLabel },
});
