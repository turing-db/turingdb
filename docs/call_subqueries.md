...
`translateLimit` at `query/ir/interpreter/NLTranslator.cpp:2463` says "once at function
...
working example of per-step state: `NLOptionalState` at `query/ir/interpreter/NLProgram.h:3364`
