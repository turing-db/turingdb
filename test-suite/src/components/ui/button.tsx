...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-full text-sm font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-ink text-paper hover:bg-steel focus-visible:ring-ink",
        accent: "bg-accent text-white hover:brightness-110 focus-visible:ring-accent",
        ghost: "bg-transparent text-ink hover:bg-black/5 focus-visible:ring-ink"
      },
      size: {
        sm: "h-8 px-3",
        md: "h-10 px-4",
