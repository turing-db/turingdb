...
private:
    ...
    void dump(std::ostream& out, const ExprChain* chain);
    void dump(std::ostream& out, const SetStmt* set);
    void dump(std::ostream& out, const SetItem* item);
    void dump(std::ostream& out, const Symbol* symbol);
