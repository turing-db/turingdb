...
inline void copyChunk(const Column* srcPtr,
    ...
    switch (srcPtr->getKind()) {
        ...
        COPY_CHUNK_CASE(ColumnVector<LabelID>)
        COPY_CHUNK_CASE(ColumnVector<EdgeTypeID>)
        COPY_CHUNK_CASE(ColumnVector<PropertyTypeID>)
        COPY_CHUNK_CASE(ColumnVector<LabelSetID>)
...
inline void copyTransformedChunk(const ColumnVector<size_t>* transform,
    ...
    switch (srcPtr->getKind()) {
        ...
        COPY_TRANSFORMED_CHUNK_CASE(ColumnVector<LabelID>)
        COPY_TRANSFORMED_CHUNK_CASE(ColumnVector<EdgeTypeID>)
        COPY_TRANSFORMED_CHUNK_CASE(ColumnVector<PropertyTypeID>)
        COPY_TRANSFORMED_CHUNK_CASE(ColumnVector<LabelSetID>)
