...
template class GetPropertiesIterator<NodeID, types::List>;
...
template class GetPropertiesIterator<EdgeID, types::List>;
...
template class GetPropertiesChunkWriter<NodeID, types::List>;
...
template class GetPropertiesChunkWriter<EdgeID, types::List>;
