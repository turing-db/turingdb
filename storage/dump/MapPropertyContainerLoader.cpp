...
MapPropertyContainerLoader::MapPropertyContainerLoader(fs::FilePageReader& reader)
    : _reader(reader)
{
}

MapPropertyContainerLoader::~MapPropertyContainerLoader() {
}

DumpResult<std::unique_ptr<PropertyContainer>> MapPropertyContainerLoader::load() {
    Profile profile("MapPropertyContainerLoader::load");
    ...
    auto* container = new TypedPropertyContainer<types::Map>;
    ...
    MapContainer& values = container->_values;
