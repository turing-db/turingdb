...
struct OutputtedTypes {
  using Allowed = GenerateKindList<std::tuple<
      types::Int64::Primitive, types::Int64::Primitive,
      types::UInt64::Primitive, types::Double::Primitive,
      types::String::Primitive, types::Bool::Primitive,
      types::Embedding::Primitive, ListView,
